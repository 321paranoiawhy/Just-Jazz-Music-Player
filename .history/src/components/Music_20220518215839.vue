<template>
    ...
    <div class="container">
        ...
        <!-- <p>{{ player.currentTime }}:{{ player.duration }}</p> -->
...
export default {
    ...
    mounted() {
        ...
        //         case 1:
        //             this.playSong(this.defaultIndex);
        //             break;
        //         case 2:
        //             this.playRandomSong();
        //             break;
    ...
    // computed: {
    //     // 当前时长 和 总时长
    //     // 参考链接: https://juejin.cn/post/6844903796942995470
    //     // 音频媒体事件加载顺序
    ...
    //         //     console.log(this.formatTime(this.player.currentTime));
    ...
    //         //     console.log(this.formatTime(this.player.duration));
