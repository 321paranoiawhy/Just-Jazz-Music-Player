<template>
    ...
    <div class="grid-bottom">
        ...
        <div v-if="canvasVisulaizer.slice(0, 3).includes(currentVisualizer)">
            <img
                :src="
                    require('../assets/images/' +
                        visualizationData[0].picture_src +
                        '.svg')
                "
                alt=""
                width="64"
                height="64"
                style="
                    filter: invert(46%) sepia(66%) saturate(2573%) hue-rotate(232deg) brightness(103%) contrast(104%;
                "
            />
        </div>
        <div
...
export default {
    ...
    data() {
        return {
            ...
            filterColor: [
                "invert(57%) sepia(49%) saturate(1185%) hue-rotate(179deg) brightness(98%) contrast(105%)",
                "invert(87%) sepia(10%) saturate(2263%) hue-rotate(63deg) brightness(92%) contrast(85%)",
                "invert(46%) sepia(66%) saturate(2573%) hue-rotate(232deg) brightness(103%) contrast(104%)",
                "invert(42%) sepia(10%) saturate(7079%) hue-rotate(328deg) brightness(103%) contrast(100%)",
                "invert(84%) sepia(33%) saturate(2499%) hue-rotate(324deg) brightness(102%) contrast(101%)",
            ],
            // 当前可视化选项
