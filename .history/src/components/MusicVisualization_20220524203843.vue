...
export default {
    ...
    methods: {
        ...
        musicVisualization() {
            ...
            // To solve this: https://stackoverflow.com/questions/35492397/remove-createmediaelementsource
            // You can set the context and source to the globally defined variable instead of redefining the variables
            // 1. context = context || new AudioContext();
            // 2. source = source || context.createMediaElementSource(audio);
            ...
            if (this.source == undefined) {
                // Build element
                this.source =
                    window.audioContext.createMediaElementSource(video);
            }
