<template>
    ...
    <div class="container">
        ...
        <!-- 父组件获取子组件的值 -->
        <VerticalSlider @getVolume="adjustVolume"></VerticalSlider>
        <p>{{ player.volume }}</p>
...
export default {
    ...
    mounted() {
        ...
        // 控制
        this.$refs.volumeBottom.addEventListener("mouseover", () => {
            console.log(this.$refs.volumeBottom);
            console.log(this.$refs.volumeUp);
            // this.$refs.volumeUp.style.display = "none";
        });
        this.$refs.volumeBottom.addEventListener("mouseout", () => {
            // this.$refs.volumeUp.style.display = "block";
        });
    },
    methods: {
        changeStyle(index) {
...
.container {
    ...
    // & .show-slider:hover .slider-right {
    //     display: block;
    // }
}
</style>
