...
export default {
    ...
    data() {
        return {
            ...
            // 是否已静音 (0 未静音 1 已静音)
            muteOrUnmute: 0,
            // 历史播放歌曲索引 (使用 Set 集合类型, 避免 push 重复歌曲索引进去)
            historyPlayedSongIndex: new Set(),
        };
    },
    // 当 currentSongIndex 变动时, 将其添加至 historyPlayedSongIndex
    watch: {
    ...
    mounted() {
        ...
        // 提交 historyPlayedSongIndex 至 vuex
        this.$store.commit(
            "getGlobalPlayedSongIndex",
            this.historyPlayedSongIndex
        );
