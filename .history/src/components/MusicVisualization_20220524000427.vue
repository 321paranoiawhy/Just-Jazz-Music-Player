            ...
            function draw() {
                ...
                switch (_that.currentVisualizer) {
                    ...
                    case "Circle-Bars":
                        ...
                        barWidth = (WIDTH / bufferLength) * 2.5;
                        r = WIDTH / 4;
                        theta = (Math.PI * 2) / (2 * bufferLength);
                        ...
                        for (let i = 0; i < bufferLength; i++) {
                            ...
                            Ax = (r - barHeight) * Math.sin(theta * 2 * i);
                            Ay = -(r - barHeight) * Math.cos(theta * 2 * i);
                            Bx = (r + barHeight) * Math.sin(theta * 2 * i);
                            By = -(r + barHeight) * Math.cos(theta * 2 * i);
                            Cx = Bx + barWidth * Math.cos(theta * 2 * i);
                            Cy = By + barWidth * Math.sin(theta * 2 * i);
                            Dx = Ax + barWidth * Math.cos(theta * 2 * i);
                            Dy = Ay + barWidth * Math.sin(theta * 2 * i);
                            canvasCtx.beginPath();
