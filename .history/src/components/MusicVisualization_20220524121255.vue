<template>
    ...
    <div class="grid-bottom">
        ...
        <div v-for="(item, index) in [0, 1, 2, 3, 4, 5, 6]" :key="index">
            <!-- <div v-if="canvasVisulaizer.indexOf(currentVisualizer) === index"> -->
            <img
                v-if="canvasVisulaizer.indexOf(currentVisualizer) === index"
                :src="
                    require('../assets/images/' +
                        visualizationData[index].picture_src +
                        '.svg')
                "
                alt=""
                width="64"
        ...
        <!-- <div v-if="canvasVisulaizer.indexOf(currentVisualizer)===0">
            <img
                :src="
                    require('../assets/images/' +
        ...
        <!-- <div v-if="canvasVisulaizer.indexOf(currentVisualizer) === 1">
            <img
                :src="
                    require('../assets/images/' +
                        visualizationData[1].picture_src +
                        '.svg')
                "
                alt=""
                width="64"
