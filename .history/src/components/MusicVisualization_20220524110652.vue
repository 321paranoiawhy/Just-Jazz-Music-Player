    ...
    <div class="grid-bottom">
        ...
        <div v-if="canvasVisulaizer.slice(0, 3).includes(currentVisualizer)">
            <img
                ...
                height="64"
                style="
                    filter: invert(63%) sepia(46%) saturate(3724%)
                        hue-rotate(180deg) brightness(101%) contrast(100%);
                "
                ref="filterColor"
            />
        </div>
...
export default {
    ...
    data() {
        return {
            ...
            filterColor: [
                "invert(63%) sepia(46%) saturate(3724%) hue-rotate(180deg) brightness(101%) contrast(100%)",
