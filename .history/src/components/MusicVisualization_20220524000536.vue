            ...
            function draw() {
                ...
                switch (_that.currentVisualizer) {
                    ...
                    case "Circle-Bars":
                        ...
                        barWidth = (WIDTH / bufferLength) * 2.5;
                        r = WIDTH / 4;
                        theta = (Math.PI * 2) / (n * bufferLength);
                        ...
                        for (let i = 0; i < bufferLength; i++) {
                            ...
                            Ax = (r - barHeight) * Math.sin(theta * n * i);
                            Ay = -(r - barHeight) * Math.cos(theta * n * i);
                            Bx = (r + barHeight) * Math.sin(theta * n * i);
                            By = -(r + barHeight) * Math.cos(theta * n * i);
                            Cx = Bx + barWidth * Math.cos(theta * n * i);
                            Cy = By + barWidth * Math.sin(theta * n * i);
                            Dx = Ax + barWidth * Math.cos(theta * n * i);
                            Dy = Ay + barWidth * Math.sin(theta * n * i);
                            canvasCtx.beginPath();
                    ...
                    case "Circle-Beat":
                        ...
                        for (let i = 0; i < bufferLength; i++) {
                            barHeight = dataArray[i] / 2;
                            // if (i === 0) {
                            //     convasCtx.lineTo(0, -(r + dataArray[0] / 4));
                            // } else {
                            //     canvasCtx.lineTo(
